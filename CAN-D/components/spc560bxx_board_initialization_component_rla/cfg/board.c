...
static const spc_siu_init_t spc_siu_init[] = {
  {(int32_t)PCR_INDEX(PORT_B, PIN_LIN0TX), PAL_HIGH,   (iomode_t)(PAL_MODE_OUTPUT_ALTERNATE(1))},
  {(int32_t)PCR_INDEX(PORT_B, PIN_LIN0RX), PAL_HIGH,   (iomode_t)(PAL_MODE_INPUT)},
  {(int32_t)PCR_INDEX(PORT_C, PC_LED8), PAL_LOW,    (iomode_t)(PAL_MODE_OUTPUT_PUSHPULL)},
  {(int32_t)PCR_INDEX(PORT_C, PC_LED7), PAL_LOW,    (iomode_t)(PAL_MODE_OUTPUT_PUSHPULL)},
  {-1, 0, 0}
};
