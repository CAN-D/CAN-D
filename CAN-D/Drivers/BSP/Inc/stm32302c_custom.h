...
#define LEDx_GPIO_CLK_DISABLE(__LED__) (((__LED__) == LED1) ? LED1_GPIO_CLK_DISABLE() : ((__LED__) == LED2) ? LED2_GPIO_CLK_DISABLE() : ((__LED__) == LED3) ? LED3_GPIO_CLK_DISABLE() : 0)
...
#define LOG_BUTTON_EXTI_IRQn EXTI15_10_IRQn

#define MARK_BUTTON_PIN GPIO_PIN_12 // PB.12
