...
class TraceTab(QWidget):
    def __init__(self, controller):
        """ Initializes the UI for the Trace tab.
    ...
    def scrollTraceToBottom(self, parent, start, end):
        """ Scrolls the trace table to the bottom whenever the dataset changes.
        """
        QtCore.QTimer.singleShot(0, self.TraceTable.scrollToBottom)

    def canIdFilterChanged(self, text):
        """ Updates the controller property whenever the can_id text edit value is changed.
        """
        self.controller.can_id = text

    def canMaskFilterChanged(self, text):
        """ Updates the controller property whenever the can mask text edit value is changed.
        """
        self.controller.can_mask = text

    def pathEditChanged(self, text):
        """ Updates the controller property whenever the path text edit value is changed.
        """
        self.controller.dbcpath = text

    def resetFilter(self):
        """ Clears all the text edits
        """
    ...
    def openFileDialog(self):
        """ Opens a file dialog to load the DBC file.
        """
