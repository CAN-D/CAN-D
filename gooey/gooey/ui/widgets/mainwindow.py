...
class CAND_MainWindow(QMainWindow):
    ...
    def __init__(self, isdemo=False, isloopback=False, trace_location=None):
        """ Initializes the UI for the main window.

            Code below is mostly autogenerated by QtDesigner, with some changes to
            link to the model.
        """
        super().__init__()

        self.controller = MainController(isdemo, isloopback, trace_location)
    ...
    def saveFile(self):
        """ Saves the current dataset to a CAN-D Trace file.
        """
    ...
    def connectUsb(self):
        """ Links the 'Connect' button to the connect method in the controller
        """
    ...
    def startPoll(self):
        """ Links the 'Start Poll' button to the method in the controller
        """
    ...
    def disconnectUsb(self):
        """ Links the 'Disconnect' button to the method in the controller
        """
    ...
    def startLoggingSD(self):
        """ Links the 'Start Log' button to the method in the controller
        """
    ...
    def stopLoggingSD(self):
        """ Links the 'Stop Log' button to the method in the controller
        """
    ...
    def transmitMessage(self):
        """ Launches a transmit window where the user can fill in fields to transmit
    ...
    def retransmitMessage(self):
        """ Retransmits a selected message to the UI.
        """
    ...
    def markLog(self):
        """ Links the "Mark" button to the method in the controller
        """
    ...
    def setDbcCallback(self):
        """ The callback that is called when the user sets a DBC file.
        """
    ...
    def formatHexData(self, s):
        """ Formats hex data to a readable format.

            Example:
            00a1ccad0b -> 00 A1 CC AD 0B
        """
        return (" ".join(s[i:i+2] for i in range(0, len(s), 2))).upper()

    def formatId(self, id):
        """ Formats the can_id to a readable format.
