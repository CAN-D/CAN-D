...
class RxTxTab(QWidget):
    def __init__(self, controller):
        """ Initializes the UI for the RxTx tab.
    ...
    def scrollTransmitToBottom(self, parent, start, end):
        """ Scrolls the transmit table to the bottom whenever the dataset changes.
        """
    ...
    def scrollReceiveToBottom(self, parent, start, end):
        """ Scrolls the receive table to the bottom whenever the dataset changes.
        """
